        ...
        for (int i = 1; i <= metaData.getColumnCount(); i++) {
            switch (metaData.getColumnName(i)) {
                ...
                case "creationTime":
                    ...
                    break;
                case "type":
                    event.setType(resultSet.getString(i).equals(EventType.ENTER.toString()) ?
                            EventType.ENTER : EventType.LOGOUT);
                    break;
                default:
                    // No operations.
            }
    ...
    public void save(Event event) {
        try (Connection connection = DATA_SOURCE.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement(
                    "INSERT INTO `Event` (`userId`, `type`, `creationTime`) VALUES (?, ?, NOW())", Statement.RETURN_GENERATED_KEYS)) {
